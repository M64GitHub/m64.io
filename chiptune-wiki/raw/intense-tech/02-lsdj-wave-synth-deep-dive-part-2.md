RAW: Intense Tech with Defense Mech — LSDj Wave Synth Deep Dive Part 2 (2018-11-08) | https://defensemech.com/intense-tech/en/02-lsdj-wave-synth-deep-dive-part-2.md.html | fetched 2026-08-30 | Markdeep body of the page (HTML head, footer script and media files stripped; video/image links left as-is) | CC BY-NC-SA 4.0
...
Previous: [ <-- Part 1 ](01-lsdj-wave-synth-deep-dive-part-1.md.html) <span class="next">Next: [Don't Sleep on Z --> ](03-dont-sleep-on-z-feat-hypnogram.md.html)</span>
-----------------------------------------
