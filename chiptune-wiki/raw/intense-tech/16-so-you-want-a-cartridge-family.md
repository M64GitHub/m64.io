RAW: Intense Tech with Defense Mech — So You Want a Cartridge Family? (2020-05-21) | https://defensemech.com/intense-tech/en/16-so-you-want-a-cartridge-family.md.html | fetched 2026-08-30 | Markdeep body of the page (HTML head, footer script and media files stripped; video/image links left as-is) | CC BY-NC-SA 4.0
...
!!! WARNING
   **Update for 2024**
   ...
   Unfortunately, I can no longer recommend the EZ Flash Jr. due to numerous quality issues that 
   prevent it from being a good choice for LSDJ. I still recommend insideGadgets cartridges, as well 
   as Everdrive cartridges from krikzz, as the best choices for LSDJ at this time.

First, A Warning
----------------

You might be tempted to search sites like eBay for "LSDJ Cartridge", but buyer beware! There is no 
such thing as an "official LSDJ cartridge", and any cartridges labeled this way are likely to be 
scams.  The LSDJ software license specifically disallows the sale of LSDJ cartridges, so if you see 
an item labeled "LSDJ Cartridge for Nintendo Game Boy" or something similar, such a cartridge 
violates the LSDJ software license and is an unofficial bootleg. Additionally, these cartridges are 
usually very low quality. They don't feature the ability to customize or upgrade the LSDJ rom or the 
ability to back up your save files. You should only purchase cartridges from a trusted source.  
Below, I'll provide good examples of cartridges that are robust and reliable.
...
years, are the Krikzz Everdrive GB (X3/X5/X7), ~~the BennVenn El Cheapo SD, and the EZ Flash Junior.~~ As these carts are no longer available, I recommend the Everdrive X5 
which has the best balance of compatibility, reliability, and price.
...
necessary 128kb SRAM that is required for LSDj to function. ~~A much cheaper alternative is the EZ Flash Jr, which can be purchased for around $50 on Amazon](https://www.amazon.com/s?k=ez+flash+jr) as well as Game Boy modding shops (*Note: prices may have risen since this article's publication depending on availability so it may be worthwhile to check different vendor websites*).~~

~~If you plan to use an EZ Flash Jr, you will need to download the firmware from the website [ezflash.cn](https://ezflash.cn) and load the "[ezgb.dat](https://penzeys.com)" file onto the root folder of the microSD card. You can also copy the LSDj rom onto the root of the microSD card. When you boot the cartridge up, a menu appears with the options to select the LSDj rom. After loading the save file into memory, LSDj will start (save files go into the "SAVER" folder on the microSD card).~~
...
$29](https://shop.insidegadgets.com/product/gameboy-1mb-128kb-sram-flash-cart-ultra-low-power-great-for-lsdj/).
...
ROM 128kb FRAM
cartridge](https://shop.insidegadgets.com/product/gameboy-4mb-128kb-fram-flash-cart-low-power/)
uses battery-less memory, meaning you will never have to worry about a
lost save due to a dead cartridge battery. That's pretty great! (Assuming the cart is still 
available...)

------------------------------------------

I hope you enjoyed this tour through the world of Gameboy cartridges! Thanks to all my patrons for 
their support.  If you'd like to offer support, please consider [joining me on 
Patreon](https://patreon.com/defensem3ch).  It means a lot and it helps me continue to make and host 
this content, pay for translations, and get your input on what kinds of articles to write next!
<center>
  <p>
...
Previous: [ <-- Let's Mix it Up and Down ](15-lets-mix-it-up-and-down.md.html) <span class="next">Next: [ Noise channel --> ](17-the-joys-of-noise.md.html)</span>
-----------------------------------------
