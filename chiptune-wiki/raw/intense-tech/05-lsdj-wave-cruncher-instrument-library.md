RAW: Intense Tech with Defense Mech — LSDj Wave Cruncher Instrument Library! (2019-03-28) | https://defensemech.com/intense-tech/en/05-lsdj-wave-cruncher-instrument-library.md.html | fetched 2026-08-30 | Markdeep body of the page (HTML head, footer script and media files stripped; video/image links left as-is) | CC BY-NC-SA 4.0
...
I hope you enjoyed this tour through the wave cruncher synth library! Thanks to all my patrons for their 
...
Previous article: [ <-- libLSDJ ](04-manage-your-lsdj-save-files-with-liblsdj.md.html) <span class="next">**Next article:** [ Groove Tricks Part 1 --> ](06-groovy-groove-and-tick-tricks-part-1.md.html)</span>
-----------------------------------------
