RAW: Intense Tech with Defense Mech — LSDj Wave Synth Deep Dive Part 1 (2018-10-11) | https://defensemech.com/intense-tech/en/01-lsdj-wave-synth-deep-dive-part-1.md.html | fetched 2026-08-30 | Markdeep body of the page (HTML head, footer script and media files stripped; video/image links left as-is) | CC BY-NC-SA 4.0
...
<span class="next">Next: [Part 2 --> ](02-lsdj-wave-synth-deep-dive-part-2.md.html)</span>
-----------------------------------------
