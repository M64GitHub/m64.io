/* Chiptune Wiki viewer — force-directed link graph on <canvas>. Used by graph.html and by the local graph on every page. */
window.WikiGraph = (function () {
  'use strict';
  const COLORS = { technique: '#5fd9e0', concept: '#ffb454', entity: '#ff6fa5', summary: '#7ee787', wanted: '#ff5c5c', other: '#8890ad' };
  const ALL_TYPES = ['technique', 'concept', 'entity', 'summary', 'wanted'];
  ...
  function create(canvas, data, opts) {
    ...
    function layoutRadial() {
      ...
      const order = { technique: 0, concept: 1, entity: 2, summary: 3, wanted: 4 };
